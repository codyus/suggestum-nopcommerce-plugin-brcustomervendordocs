...
public class ViewLocationExpander : IViewLocationExpander
{
    ...
    public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
    {
        ...
        {
            viewLocations = new[] { $"/Plugins/Misc.BrCustomerVendorDocs/Areas/Admin/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
        }
        else
        {
            viewLocations = new[] { $"/Plugins/Misc.BrCustomerVendorDocs/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
        }
